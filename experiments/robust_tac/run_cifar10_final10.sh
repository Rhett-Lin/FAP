...
run_one cifar10_final10_static_ca_eg_text \
  --mode static

run_one cifar10_final10_vprompt_ca_eg_text \
  --mode vprompt --prompt-depth 1 --n-ctx 2

run_one cifar10_final10_tprompt_ca_eg_text \
  --mode tprompt --n-ctx 2

run_one cifar10_final10_tprompt_ca_eg_text_sym005 \
  --mode tprompt --eg-symmetric --eta-sym 0.05 --n-ctx 2

run_one cifar10_final10_tprompt_ca_eg_text_sym01 \
